...
export const Battle = () => {
  ...
  const [player, setPlayer] = useState<IPlayer>({ hp: 100, status:'normal', position:{x:1, y:1}});
  const [enemy, setEnemy] = useState<IEnemy>({ hp: 300, status:'normal', position:{x:4, y:1}});
